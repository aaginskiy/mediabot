...
const checkMux = require('../check-mux')
  ...
  describe("when 'type' is 'before'", () => {
    ...
    goodVerbTypes.forEach((method) => {
      describe(`and when 'method' is '${method}'`, () => {
        ...
        it("should set 'isMuxed' = true if all tracks are muxed and are in order", () => {
          mock.data.tracks = [
            {
              isMuxed: true,
              newNumber: 1,
        ...
        it("should set 'isMuxed' = false if any tracks are not in order", () => {
          mock.data.tracks = [
            {
              isMuxed: true,
              newNumber: 1,
