...
const DiskScannerService = require('../../../../src/api/services/utils/disk-scanner/disk-scanner.service')
...
describe('\'Disk Scanner\' service', () => {
  let app, DiskScanner, Movies, Jobs
  ...
  describe('#refreshAllMediainfo', () => {
    ...
    it('refreshes existing media', async () => {
      ...
      expect(Jobs.create).toBeCalledTimes(1)
      expect(Jobs.create).toBeCalledWith(expect.objectContaining({
